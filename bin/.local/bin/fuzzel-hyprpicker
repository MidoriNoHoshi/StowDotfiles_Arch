...
# Made by wimpysworld (Thank you for uploading this script onto the internet. I will happily use it.)
# Though I will change it to use dunst instead of whatever notify-osd is.

set +u  # Disable nounset
APP_NAME="fuzzel-hyprpicker"
NOTIFY="dunstify --appname=$APP_NAME --icon=org.gnome.design.Palette"
